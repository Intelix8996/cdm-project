...
dc N_CELL, N_CELL, N_CELL, E_CELL, N_CELL, K_CELL, K_CELL, N_CELL, N_CELL, N_CELL
dc N_CELL, K_CELL, N_CELL, N_CELL, N_CELL, N_CELL, N_CELL, N_CELL, S_CELL, S_CELL
dc N_CELL, K_CELL, N_CELL, N_CELL, S_CELL, N_CELL, E_CELL, N_CELL, N_CELL, N_CELL
dc N_CELL, K_CELL, N_CELL, N_CELL, N_CELL, N_CELL, N_CELL, N_CELL, N_CELL, N_CELL
dc N_CELL, N_CELL, N_CELL, S_CELL, N_CELL, N_CELL, S_CELL, N_CELL, K_CELL, N_CELL
