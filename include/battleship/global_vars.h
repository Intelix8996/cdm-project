...
#define CUR_DISPLAY     0x04 // Currently active Display
#define NUM_CELL        0x05 // Addr of a number of a cell a cursos is pointing to. 0x80 <= *NUM_CELL <= 0xe4
#define PLAYERS_TURN    0x06 // Contains a cell, that Player have chose

#define X_CURSOR_COPY   0x08 // Contains a copy of X_CURSOR content
#define Y_CURSOR_COPY   0x09 // Contains a copy of Y_CURSOR content
#define NUM_CELL_COPY   0x0a // Contains a copy of NUM_CELL content
