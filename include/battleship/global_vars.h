...
#define X_COMP_PTR      0xf8 // X coordinate of a cell that was selected during Computer's turn
#define Y_COMP_PTR      0xf9 // Y coordinate of a cell that was selected during Computer's turn
